            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      context.tr('permission_location_title'),
                    ...
                    Text(
                      context.tr('permission_location_subtitle'),
                      textAlign: TextAlign.center,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    isLoading
                        ? context.tr('permission_location_enabling')
                        : context.tr('permission_location_enable'),
              ...
              if (showOpenLocationSettingsButton &&
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      context.tr('permission_open_location_settings'),
                      style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.w800,
                      ),
              ...
              TextButton(
                ...
                child: Text(
                  context.tr('permission_skip_now'),
